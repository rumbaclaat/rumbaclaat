...
const NAV: NavItem[] = [
  ...
  { href: "/admin/membership", label: "RPM tiers", icon: "bi-award", group: "RPM" },
  { href: "/admin/rewards", label: "Rewards", icon: "bi-trophy", group: "RPM" },
  { href: "/admin/newsletter", label: "Newsletter", icon: "bi-envelope-paper", group: "Marketing" },
  { href: "/admin/settings", label: "Store settings", icon: "bi-gear", group: "Store" },
  { href: "/admin/tax-classes", label: "Tax classes", icon: "bi-receipt", group: "Store" },
  { href: "/admin/shipping-classes", label: "Shipping classes", icon: "bi-truck", group: "Store" },
  { href: "/admin/shipping-zones", label: "Shipping zones", icon: "bi-globe", group: "Store" },
  { href: "/admin/currencies", label: "Currencies", icon: "bi-currency-exchange", group: "Store" },
