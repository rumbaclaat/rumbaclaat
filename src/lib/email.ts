...
export function emailShell(title: string, bodyHtml: string): string {
  return `<!doctype html><html><body style="margin:0;background:#0E0E12;color:#F5F0E8;font-family:Inter,Arial,sans-serif">
  <div style="max-width:560px;margin:0 auto;padding:28px">
    <div style="font-family:Georgia,serif;font-size:22px;color:#E6D2A0;letter-spacing:.04em">Rumbaclaat<span style="color:#CDB582">.</span></div>
    ...
    <hr style="border:none;border-top:1px solid rgba(205, 181, 130,.18);margin:24px 0"/>
